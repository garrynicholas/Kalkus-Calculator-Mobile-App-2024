...
class _LengthCalculatorState extends State<LengthCalculator> {
  ...
  String _selectedUnit1 = 'Meter';
  String _selectedUnit2 = 'Meter';
  ...
  void _calculateResult() {
    ...
    _controller2.text = result.toStringAsFixed(0);
  }

  double _convert(double value, String fromUnit, String toUnit) {
    double valueInMeter = value * conversionFactors[fromUnit]!;
    double result = valueInMeter / conversionFactors[toUnit]!;
    return result;
  }
