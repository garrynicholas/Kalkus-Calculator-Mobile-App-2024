...
class MassCalculator extends StatefulWidget {
  @override
  _MassCalculatorState createState() => _MassCalculatorState();
}

class _MassCalculatorState extends State<MassCalculator> {
  ...
  String _selectedUnit1 = 'Kilogram';
  String _selectedUnit2 = 'Kilogram';
  ...
  double _convert(double value, String fromUnit, String toUnit) {
    double valueInKilogram = value * conversionFactors[fromUnit]!;
    double result = valueInKilogram / conversionFactors[toUnit]!;
    return result;
  }
